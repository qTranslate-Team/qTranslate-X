...
{//updates
	...
	function qtranxf_slug_clean_request( $nm ) {
		...
		if ( empty( $_GET['qtranslate-slugs'] ) ) {
			unset( $_GET['qtranslate-slugs'] );
		}
		if ( empty( $_POST['qtranslate-slugs'] ) ) {
			unset( $_POST['qtranslate-slugs'] );
		}
		if ( empty( $_REQUEST['qtranslate-slugs'] ) ) {
			unset( $_REQUEST['qtranslate-slugs'] );
		}
	}
