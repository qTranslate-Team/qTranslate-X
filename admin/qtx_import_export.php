	...
	<table class="form-table">
		<tr valign="top" id="qtranslate-convert-database">
			...
			<td>
				...
				<label for="qtranxs_convert_database_to_s_only"><input type="radio" name="convert_database" id="qtranxs_convert_database_to_s_only" value="s_only" />&nbsp;<?php echo __('Convert database to the "swirly bracket only" style.', 'qtranslate') ?></label><br/>
				<small><?php printf(__('The swirly bracket language tag %s only will be used as opposite to [ tag legacy format. All string options and standard post and page fields will be uniformly encoded like %s.','qtranslate'),'{:}','{:}','qTranslate','"{:en}English{:de}Deutsch{:}"') ?></small><br/><br/>
