                ...
                <div class="tabs-content"><?php //<!-- tabs-container --> ?>
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
							...
							if($permalink_is_query) {
								...
								echo PHP_EOL.'<br/><br/>'.PHP_EOL;
                                    ...
                                    <label title="Pre-Path Mode"><input type="radio" name="url_mode" value="<?php echo QTX_URL_PATH; ?>" <?php checked( $url_mode, QTX_URL_PATH );
										disabled( $permalink_is_query ) ?> /> <?php echo __( 'Use Pre-Path Mode (Default, puts /en/ in front of URL)', 'qtranslate' ) . '. ' . __( 'SEO friendly.', 'qtranslate' ) ?></label><br/>
						...
						<p class="qtranxs_notes"><?php _e('Pre-Path and Pre-Domain mode will only work with mod_rewrite/pretty permalinks. Additional Configuration is needed for Pre-Domain mode or Per-Domain mode.', 'qtranslate') ?></p><br/><br/>
									...
									?>
                                    <label for="hide_default_language">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="hide_default_language" id="hide_default_language"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <br/>
                                <label for="hide_untranslated"><input type="checkbox" name="hide_untranslated" id="hide_untranslated"
                                                                      value="1"<?php checked( $q_config['hide_untranslated'] ) ?>/> <?php _e( 'Hide Content which is not available for the selected language.', 'qtranslate' ) ?></label>
                                <br/>
                                ...
                                <br/>
                                <label for="show_displayed_language_prefix"><input type="checkbox" name="show_displayed_language_prefix" id="show_displayed_language_prefix"
                                ...
                                <br/>
                                <label for="show_alternative_content_message"><input type="checkbox" name="show_alternative_content_message" id="show_alternative_content_message"
                                                                                     value="1"<?php checked( $q_config['show_alternative_content_message'] ) ?>/> <?php _e( 'When content is displayed in an alternative language, show an explanatory message.', 'qtranslate' ) ?>
                                </label>
                                ...
                                <br/>
                                <label for="show_alternative_content"><input type="checkbox" name="show_alternative_content" id="show_alternative_content"
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <label for="detect_browser_language"><input type="checkbox" name="detect_browser_language" id="detect_browser_language"
                    ...
                    <table class="form-table">
						...
						if ( $q_config['use_strftime'] == QTX_DATE_WP ) {
                            ...
                            <tr valign="top">
                                <td colspan="2"><p
                                            class="qtranxs_notes"><?php echo sprintf( __( 'To add a new format, type it into the empty "%s" field and provide its customization per language in the field "%s".', 'qtranslate' ), __( 'Date/Time Format', 'qtranslate' ), __( 'Localization', 'qtranslate' ) ) . ' ' . sprintf( __( 'To remove a raw, clear its "%s" field.', 'qtranslate' ), __( 'Date/Time Format', 'qtranslate' ) ) ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" class="i18n-anchor-lsb"></td>
					...
					*/ ?>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            ...
                            <td>
                                <label for="post_types"><?php _e( 'Post types enabled for translation:', 'qtranslate' ) ?></label>
                                <p>
									<?php
                                ...
                                <p class="qtranxs_notes"><?php _e( 'If a post type unchecked, no fields in a post of that type are treated as translatable on editing pages. However, the manual raw multilingual entries with language tags may still get translated in a usual way at front-end.', 'qtranslate' ) ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row"><?php _e( 'Translation saving', 'qtranslate' ) ?></th>
                            <td>
                                <label for="force_markers"><input type="checkbox" name="force_markers" id="force_markers"
                                                                  value="1"<?php checked( $q_config['force_markers'] ); ?> /> <?php echo __( 'Always keep language markers', 'qtranslate' ) ?></label>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <label for="disable_client_cookies"><input type="checkbox" name="disable_client_cookies" id="disable_client_cookies" value="1"<?php checked( $q_config['disable_client_cookies'] );
									disabled( $url_mode == QTX_URL_DOMAIN || $url_mode == QTX_URL_DOMAINS ) ?> /> <?php printf( __( 'Disable language client cookie "%s" (not recommended).', 'qtranslate' ), QTX_COOKIE_NAME_FRONT ) ?></label>
                                ...
                                <br/>
                                <label for="use_secure_cookie"><input type="checkbox" name="use_secure_cookie" id="use_secure_cookie"
                                                                      value="1"<?php checked( $q_config['use_secure_cookie'] ) ?> /><?php printf( __( 'Make %s cookies available only through HTTPS connections.', 'qtranslate' ), 'qTranslate&#8209;X' ) ?>
                                </label>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <label for="auto_update_mo"><input type="checkbox" name="auto_update_mo" id="auto_update_mo"
                                                                   value="1"<?php checked( $q_config['auto_update_mo'] ) ?>/> <?php _e( 'Automatically check for .mo-Database Updates of installed languages.', 'qtranslate' ) ?></label>
                                <br/>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <label for="filter_options_mode_all"><input type="radio" name="filter_options_mode" id="filter_options_mode_all" value=<?php echo '"' . QTX_FILTER_OPTIONS_ALL . '"';
                                ...
                                <br/>
                                <label for="filter_options_mode_list"><input type="radio" name="filter_options_mode" id="filter_options_mode_list" value=<?php echo '"' . QTX_FILTER_OPTIONS_LIST . '"';
                        ...
                        <tr valign="top" id="option_editor_mode">
                            ...
                            <td>
                                <label for="qtranxs_editor_mode_lsb"><input type="radio" name="editor_mode" id="qtranxs_editor_mode_lsb"
                                ...
                                <p class="qtranxs_notes"><?php echo __( 'This is the default mode.', 'qtranslate' ) . ' ' . __( 'Pages with translatable fields have Language Switching Buttons, which control what language is being edited, while admin language stays the same.', 'qtranslate' ) ?></p>
                                <br/>
                                <label for="qtranxs_editor_mode_raw"><input type="radio" name="editor_mode" id="qtranxs_editor_mode_raw"
                                    ...
                                    . <?php _e( 'Do not use Language Switching Buttons to edit multi-language text entries.', 'qtranslate' ) ?></label>
                                <p class="qtranxs_notes"><?php _e( 'Some people prefer to edit the raw entries containing all languages together separated by language defining tags, as they are stored in database.', 'qtranslate' ) ?></p>
                                <br/>
                                <label for="qtranxs_editor_mode_single"><input type="radio" name="editor_mode" id="qtranxs_editor_mode_single"
                            ...
                            <tr valign="top" id="option_lsb_style">
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <br/><?php printf( __( 'LSB %s-wrap classes:', 'qtranslate' ), 'ul' ) ?>&nbsp;<input type="text" name="lsb_style_wrap_class" id="lsb_style_wrap_class"
                                                                                                                             value="<?php echo $q_config['lsb_style_wrap_class']; ?>" size="50">
                                        <br/><?php _e( 'Active button class:', 'qtranslate' ) ?>&nbsp;<input type="text" name="lsb_style_active_class" id="lsb_style_active_class" value="<?php echo $q_config['lsb_style_active_class']; ?>"
                                                                                                             size="40">
...
*/ ?>
                    ...
                    <table class="form-table">
                        <tr valign="top">
                            <td scope="row" colspan="2"><p
									...
									echo ' ';
									printf( __( 'Read %sIntegration Guide%s for more information on how to customize the configuration of %s.', 'qtranslate' ), '<a href="https://qtranslatexteam.wordpress.com/integration/" target="_blank">', '</a>', 'qTranslate&#8209;X' ); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
			...
			<?php */ ?>
                        <tr valign="top">
                            ...
                            <td>
                                <label for="qtranxs_qtrans_compatibility"><input type="checkbox" name="qtrans_compatibility" id="qtranxs_qtrans_compatibility"
                ...
                <div id="col-right">
                    <div class="col-wrap">
                        ...
                        <p class="qtranxs_notes"><?php
							...
							echo ' ';
							printf( __( 'Click %s to modify language properties.', 'qtranslate' ), __( 'Name', 'qtranslate' ) );
							?></p>
						<?php
